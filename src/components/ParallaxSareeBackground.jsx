...
export default function ParallaxSareeBackground() {
  ...
  const translateY1 = scrollY * 0.45;
  const translateY2 = scrollY * 0.35;
  const rotation1 = Math.sin(scrollY * 0.002) * 8;
  const rotation2 = Math.cos(scrollY * 0.002) * -6;

  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden select-none">
      
      {/* Primary Floating Light Saree */}
      <div 
      ...
      >
        <img 
          src={getImageUrl("images/kanchipuram.png")} 
      ...
      {/* Secondary Accent Floating Saree */}
      <div 
      ...
      >
        <img 
          src={getImageUrl("images/dharmavaram.png")} 
