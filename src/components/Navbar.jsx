...
export default function Navbar({
  ...
  return (
    <header
      style={{ position: "sticky", top: 0, zIndex: 50, transition: "all 0.3s" }}
    >
      {/* Top Banner */}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                ...
                <ChevronDown
                  style={{ width: 12, height: 12, color: "#e5c158" }}
                />
              </button>
                ...
                >
                  ...
                  {languages.map((l) => (
                    <button
                      ...
                      onMouseEnter={(e) =>
                        (e.target.style.background = "#25101a")
                      }
                      onMouseLeave={(e) =>
