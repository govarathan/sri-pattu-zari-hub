      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 space-y-3">
          ...
          <p className="text-xs sm:text-sm text-amber-100/70">
            Answer 3 quick questions to get an instant spot cash estimate for
            your old silk saree collection.
          </p>
        </div>
                ...
                {[
                  {
                    ...
                    desc: "Modern Kanchipuram / Soft Silk",
                  },
                  {
                    label: "10 - 20 Years (Vintage)",
                    desc: "Heavy Pure Silver Zari Era",
                  },
                  {
                    label: "20+ Years Antique",
                    desc: "Pure Gold & Silver Weave Heritage",
                  },
                ].map((item, idx) => (
                  <button
                    key={idx}
                  ...
                  >
                    <div className="font-extrabold text-amber-100 text-base mb-1">
                      {item.label}
                    </div>
          ...
          {step === 2 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  {
                    label: "Pure Silver & Gold Zari",
                    desc: "Heavy authentic metallic thread (Highest Payout)",
                  },
                  {
                    label: "Tested Zari",
                    desc: "Combination silver & metallic copper blend",
                  },
                  {
                    label: "Commercial / Half Zari",
                    desc: "Lightweight metallic zari border",
                  },
                ].map((item, idx) => (
                  <button
                    key={idx}
          ...
          {step === 3 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  {
                    label: "Good Intact Condition",
                    desc: "Gently worn, clean silk texture",
                  },
                  {
                    label: "Slightly Damaged / Stained",
                    desc: "Strained, discolored or minor holes",
                  },
                  {
                    label: "Heavily Damaged & Torn",
                    desc: "Torn saree (We pay full Zari Silver Rate!)",
                  },
                ].map((item, idx) => (
                  <button
                    key={idx}
            ...
            <div className="space-y-6 text-center animate-fade-in">
              ...
              <div>
                <div className="text-xs text-amber-300 font-bold uppercase tracking-wider">
                  Estimated Spot Cash Payout Range
                </div>
              ...
              <div className="bg-neutral-900/90 border border-amber-500/30 p-4 rounded-xl max-w-lg mx-auto text-xs text-amber-200/80 text-left space-y-1">
                <div>
                  • <strong>Saree Age:</strong> {answers.age}
                </div>
                <div>
                  • <strong>Zari Grade:</strong> {answers.zariType}
                </div>
                <div>
                  • <strong>Condition:</strong> {answers.condition}
                </div>
              </div>
