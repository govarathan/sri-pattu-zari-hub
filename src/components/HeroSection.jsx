...
export default function HeroSection({ currentLang, onOpenBooking }) {
  ...
  const badgeStyle = {
    ...
    gap: "10px",
    background:
      "linear-gradient(to right, rgba(229,193,88,0.15), rgba(115,0,25,0.3), rgba(229,193,88,0.08))",
      ...
      <div style={containerStyle}>
          ...
          <div style={textColumnStyle}>
            ...
            <div style={highlightsGridStyle}>
              ...
              <div style={highlightCardStyle}>
                ...
                >
                  {t.hero.doorstepPickupTag}
                </span>
              </div>
            </div>

            {/* Dual Primary CTAs - Call Hotline & WhatsApp Pickup */}
            <div style={ctaStyle}>
              <a
                href="tel:6374067251"
              ...
              <a
                href="https://wa.me/916374067251?text=Hi%20Sri%20Pattu%20%26%20Zari%20Hub%2C%20I%20want%20to%20book%20a%20doorstep%20pickup%20for%20my%20silk%20sarees."
                target="_blank"
            ...
            <div style={assuranceStyle}>
              ...
              <p
                style={{
                  fontSize: "0.8rem",
                  color: "rgba(247,231,169,0.9)",
                  fontWeight: 500,
                  lineHeight: 1.6,
                }}
              >
                {t.doorstepCallout ||
                  "Instant doorstep cash payout across Tambaram, Chennai & South India. Zero hidden charges."}
              </p>
            </div>
          </div>
          ...
          <div style={visualColumnStyle}>
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "radial-gradient(circle at center, rgba(229,193,88,0.12) 0%, transparent 60%)",
                borderRadius: "50%",
                filter: "blur(64px)",
                opacity: 0.6,
              }}
              ...
              <div style={imageContainerStyle}>
                ...
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      "linear-gradient(to top, #0c0509 0%, transparent 50%)",
                    opacity: 0.85,
                  }}
                />
                <div
        ...
        <div style={statsGridStyle}>
          {[
            {
              value: "25+",
              label: t.quickStats?.years || "Years Direct Mill Experience",
              color: null,
            },
            {
              value: "50,000+",
              label: t.quickStats?.clients || "Satisfied Customers",
              color: null,
            },
            {
              value: "5 States",
              label: t.quickStats?.states || "South India Service",
              color: null,
            },
            {
              value: "Spot Cash",
              label: t.quickStats?.speed || "Instant Doorstep Payment",
              color: "#34d399",
            },
          ].map((stat, i) => (
            <div key={i} style={statCardStyle} className="scroll-reveal">
              <div
                className={stat.color ? "" : "gold-gradient-text"}
                style={{
                  fontSize: "1.75rem",
                  fontWeight: 800,
