            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    <option value="Kanchipuram Pure Silk Saree">
                      Kanchipuram Silk Saree (காஞ்சி பட்டு)
                    </option>
                    <option value="Arani / Dharmavaram Saree">
                      Arani / Dharmavaram Silk Saree
                    </option>
                    <option value="Mysore Pure Silk Saree">
                      Mysore Pure Silk Saree
                    </option>
                    <option value="Silk Veshti & Angavastram">
                      Pure Silk Veshti & Angavastram
                    </option>
                    <option value="Damaged / Torn Silk Saree">
                      Damaged / Torn Silk Saree
                    </option>
                    <option value="Raw Pure Zari Threads">
                      Raw Pure Zari Threads / Scrap Zari
                    </option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  >
                    <option value="Good Condition">
                      {t.form.goodCondition}
                    </option>
                    <option value="Slightly Worn / Stained">
                      {t.form.slightlyDamaged}
                    </option>
                    <option value="Very Old / Torn / Damaged">
                      {t.form.oldTorn}
                    </option>
                  </select>
                </div>
              ...
              <div>
                ...
                <label className="flex items-center justify-center gap-2 p-3 border border-dashed border-amber-500/40 rounded-xl cursor-pointer hover:border-amber-400 bg-neutral-900/60 transition-colors">
                  ...
                  <span className="text-xs text-amber-200 font-medium">
                    {formData.photoName
                      ? `Attached: ${formData.photoName}`
                      : "Click to select photo (Optional)"}
                  </span>
                  <input
                    type="file"
                    accept="image/*"
